...
fn.exp_port_analysis(pct_long_short=(100, 100), tc_bps=20)
...
list_pct_long_short = [(100, 100), (130, 30), (120, 50), (300, 200)]

for pct_long_short in list_pct_long_short:
    ls_idx = []
    perf_metric = 'SHARPE'
    ascending = False
    ...
    dic_sigs = {'VAL': 'ZS_VAL', 'QLT': 'ZS_QLT', 'VQ': 'ZS_VAL_QLT', 'VQAM': 'ZS_VAL_QLT_AMOM'}
    sig_long = dic_sigs[df_tmp['L_SIG']]
    sig_short = dic_sigs[df_tmp['S_SIG']]
